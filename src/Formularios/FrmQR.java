 ...
 */
public class FrmQR extends javax.swing.JFrame {

    /**
     * Creates new form FrmQR
     */
    ...
    public void paintimages() {
        ...
        icono = new ImageIcon(Img.getImage().getScaledInstance(350, 250,
                Image.SCALE_DEFAULT));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmQR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
