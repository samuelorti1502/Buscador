...
public class TextoDinamico1 extends Thread {
    int contador;
    ...
    private int tamanioMin = 20;
    private int tamanioMax = 60;
    
    final Random r=new Random();
    
    public TextoDinamico1(JLabel lblCadena, JLabel lblMensaje)
    {
    ...
    public TextoDinamico1(String cadena, int sleep, JLabel lblCadena, JLabel lblMensaje) throws Exception
    {
        try
        {
            this.cadena = cadena;
    ...
    public void run()
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                Logger.getLogger(TextoDinamico1.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
}
